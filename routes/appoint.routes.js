...
module.exports = (app) => {
    ...
    app.post('/health/api/v1/appoint', controller.create);
    ...
    app.put('/health/api/v1/appoint/:id', controller.update);

    // Route for delete appointment
    app.delete('/health/api/v1/appoint/:id', controller.delete);
}